...
- Phase 3 PENDING (writing-detail/translate/conv-review/listening/assessment: store+state normalize).
- Phase 4 PENDING (history/roadmap/profile/writing-list readers).
