...
Next: D3a (assessment algorithm, v7 — but D3 adds NO persistent fields per spec, so likely no v7 migration needed; reading graded-spread localizer + cloze confirm + subjective adjustment + CEFR A1/C2 + weighted composite).
